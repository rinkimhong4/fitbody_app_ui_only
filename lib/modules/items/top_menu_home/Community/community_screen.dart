...
class CommunityScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          AnimatedRoundedTabbarFilled(
            tabWidth: 190,
            tabs: ['Discussion Forum', 'Challenges'],
            tabContents: [_buildDiscussionForum, _buildChallenges],
          ),
        ],
      ),
    );
        ...
        Stack(
          children: [
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: CachedNetworkImageProvider(
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7BAOMIjN4A2SgH_MQu2KKoKMSgIXgcebldw&s',
                  ),
                  fit: BoxFit.cover,
                ),
              ),
            ...
            Positioned(
              right: 14,
              bottom: 15,
              child: Icon(Icons.star_rounded, size: 32, color: AppColors.white),
            ),
          ],
        ),
        _buildForums,
  ...
  get _buildChallenges {
    return Column(children: [_buildTabBarBeginner]);
  }
    ...
    final forums = [
      {
        ...
        'time': 'Today 17:05',
        'onTap': () {
          // print('Tapped Strength Training');
        },
      },
      {
        'title': 'Nutrition Tips',
        'subtitle': 'Share your diet plans',
        'actionText': 'See All',
        'time': 'Yesterday 14:30',
        'onTap': () {
          // print('Tapped Nutrition Tips');
        },
      },
      {
        'title': 'Cardio Routines',
        'subtitle': 'Best practices for endurance',
        'actionText': 'See All',
        'time': 'Today 10:15',
        'onTap': () {
          // print('Tapped Cardio Routines');
        },
      },
      {
        'title': 'Cardio Routines',
      ...
      children: [
        ...
        ...forums.map(
          (forum) => ForumItem(
            ...
            subtitle: forum['subtitle'] as String,
            actionText: forum['actionText'] as String,
            time: forum['time'] as String,
            onTap: forum['onTap'] as VoidCallback?,
          ),
        ),
      ],
    );
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(thickness: 1, color: AppColors.white.withValues(alpha: 0.5)),
        ],
      ),
    );
  }
